...
class Rebild_Data:
    ...
    def check_detect(self, read_det, img, img_copy, H, W, names):
        if len(read_det) > 1:
        ...
        for i, k in enumerate(lst_file):
            ...
            if formats != "txt":
                ...
                try:
                    ...
                    self.check_detect(lst_det, image, image_copy, H, W, name)
                except:
...
cls = Rebild_Data(r"temps_2", r"temp_reb", r"dataset_21_03_2023/no_sort", 80, 80)
cls.set_pix_x_indent(3)
cls.set_pix_y_indent(3)
cls.set_time_delay(1)
cls.set_x_rand_left(0)
cls.set_x_rand_right(0)
cls.set_y_rand_left(0)
cls.set_y_rand_right(0)
cls.walk_files()